...
namespace InmobiliariaWeb.Interfaces
{
    public interface IContratosService
    {
        ...
        Task ActualizarContrato(int Ident_Contratos, ViewModels.Contratos.ActualizarViewModel actualizarViewModel, LoginResult loginResult);
        ...
        Task<int> IdentKardexXIdentContrato(int Ident_Contratos);
        ...
        Task<List<KardexListDTO>> KardexList(int nIdent_Contratos);
    }
}
